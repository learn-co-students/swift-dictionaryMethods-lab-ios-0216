 ...
 */
var starWarsDroid = ["R2-D2", "C-3PO", "IG-88", "BB-8"]
/*: question4
 ...
 */
starWarsDroid.indexOf("IG-88")
starWarsDroid.removeAtIndex(2)
/*: question6
 ...
 */
starWarsCharacters.updateValue(starWarGangsters, forKey: "Gangsters")
...
starWarsCharacters["Jedi"] = jedi
 // Needed to set the instance of jedi back to starWarsCharacter
}
